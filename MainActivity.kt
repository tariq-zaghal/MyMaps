...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //set layout manager on RecyclerView (layout manager tells RecyclerView how to structure data on the screen)
        binding.rvMaps.layoutManager = LinearLayoutManager(this)

        //set adapter on the RecyclerView (adapter takes data and binds (connects) it to a particular view at the recycler view)
        ...
        binding.fabCreateMap.setOnClickListener {
            Log.i(TAG,"fabCreateMap clicked!")
            showAlertDialog()
        }
    }
